...
public abstract class I18n {
    ...
    public abstract String autoCheckingMysticSalesmanDesc();

    public abstract String autoCheckingMysticSalesmanStepName(String name);

    public abstract String autoCheckingMysticSalesmanCallbackScriptLabel();

    public abstract String autoCheckingMysticSalesmanStartBtn();

    public abstract String autoCheckingMysticSalesmanStopBtn();

    public abstract String autoCheckingMysticSalesmanScriptPathNotSet();

    public abstract String autoCheckingMysticSalesmanFailedReadingSettingsConfig();

    public abstract String autoCheckingMysticSalesmanFailedWritingSettingsConfig();
}
