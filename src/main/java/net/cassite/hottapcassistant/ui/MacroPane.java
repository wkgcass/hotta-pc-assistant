...
public class MacroPane extends BorderPane implements NativeKeyListener, NativeMouseListener, EnterCheck {
    ...
    private List<AssistantMacroData> macros;
    ...
    public MacroPane() {
        ...
        topVBox.getChildren().addAll(switchHBox, new VPadding(2), macroAlertLabel, new VPadding(5), knowConsequenceCheckBox, new VPadding(5));
        setTop(topVBox);
    ...
    public void nativeMousePressed(NativeMouseEvent e) {
        ...
        if (e.getButton() == NativeMouseEvent.BUTTON1) {
            buttons.add(MouseButton.PRIMARY);
        } else if (e.getButton() == NativeMouseEvent.BUTTON2) {
            buttons.add(MouseButton.SECONDARY);
        }
    }
    ...
    private boolean reloadMacro() {
        ...
        macros = a.macro.macros;
        if (macros == null) {
            macros = new ArrayList<>();
        }
        ls.setItems(FXCollections.observableList(macros));
        return true;
    }
