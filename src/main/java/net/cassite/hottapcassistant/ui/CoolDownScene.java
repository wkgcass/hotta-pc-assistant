    ...
    public CoolDownScene() {
        ...
        // weapons
        {
            for (int vwi = 0; vwi < weapons.length; ++vwi) {
...

                {
                    ...
                    weaponVBox.getChildren().addAll(image, new FusionW(weaponSelect), new FusionW(starsSelect));
                ...
                {
                    hbox.getChildren().add(new HPadding(20));
                }
...

        {
            ...
            var saveButton = new Button(I18n.get().cooldownConfigurationSave()) {{
                FontManager.get().setFont(this, settings -> settings.setSize(13));
            }};
            ...
            hbox.getChildren().addAll(label, new HPadding(5), new FusionW(equipConfig), new HPadding(5), saveButton, new HPadding(5), deleteButton);
        }

        {
            buttonsVBox.getChildren().add(new VPadding(20));
        }
...

        {
            ...
            hbox.getChildren().addAll(new VBox() {{
                getChildren().add(new FusionW(relics[0]));
                getChildren().add(new FusionW(relicsStars[0]));
            }}, new HPadding(4), new VBox() {{
                getChildren().add(new FusionW(relics[1]));
                getChildren().add(new FusionW(relicsStars[1]));
            }}, new HPadding(20), new FusionW(simulacraRefComboBox));
        }
    }
